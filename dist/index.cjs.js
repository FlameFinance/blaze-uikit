...
var MenuButton = function (props) {
    var icon = props.icon, calloutClass = props.calloutClass, label = props.label, href = props.href;
    var Icon = Icons[icon];
    var iconElement = React__default['default'].createElement(Icon, { width: "24px", mr: "8px" });
    var location = reactRouterDom.useLocation();
    return (React__default['default'].createElement(MenuEntry, { key: label, isActive: href === location.pathname, className: calloutClass ? calloutClass : undefined },
    ...
    return (React__default['default'].createElement(Wrapper, null,
        React__default['default'].createElement(StyledNav, { showMenu: showMenu },
            ...
            links.map(function (entry) {
                React__default['default'].createElement(MenuButton, { icon: entry.icon, calloutClass: entry.calloutClass, label: entry.label, href: entry.href });
            }),
...
var lightColors = __assign(__assign(__assign({}, baseColors), brandColors), { background: "#e8e8e8", backgroundDisabled: "#E9EAEB", contrast: "#191326", invertedContrast: "#FFFFFF", input: "#eeeace", tertiary: "#EFF4F5", text: "#010000", textDisabled: "#888888", textSubtle: "#3a3d3b", borderColor: "#E9EAEB", card: "rgba(0.72,0.72,0.72,0.5)", gradients: {
