...
var lightColors = __assign(__assign(__assign({}, baseColors), brandColors), { background: "#e8e8e8", backgroundDisabled: "#E9EAEB", contrast: "#191326", invertedContrast: "#FFFFFF", input: "#eeeace", tertiary: "#EFF4F5", text: "#010000", textDisabled: "#BDC2C4", textSubtle: "#3a3d3b", borderColor: "#E9EAEB", card: "#9f9f9f", gradients: {
